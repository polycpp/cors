...
Clone path used for analysis: `/data/work/lib/cors/.tmp/upstream/cors`
...
- polycpp core paths inspected: `/data/repo/polycpp/include/polycpp/http/headers.hpp`, `/data/repo/polycpp/include/polycpp/http/http.hpp`, `/data/repo/polycpp/include/polycpp/http/detail/incoming_message.hpp`, `/data/repo/polycpp/include/polycpp/http/detail/server_response.hpp`
...
- companion libs inspected for reusable APIs: `/data/work/lib/vary`
