...
- package root: `/data/work/lib/cors/.tmp/upstream/cors`
...
| vary | hard | ^1 | 1.1.2 | MIT | package.json license field and existing companion repo reviewed | permissive | use existing companion license | no | 0 | 1 | 0 | 14 | use existing polycpp companion | Existing `/data/work/lib/vary` provides `polycpp::vary::vary(polycpp::http::Headers&, ...)`; CORS must reuse it for Vary header mutation. |
